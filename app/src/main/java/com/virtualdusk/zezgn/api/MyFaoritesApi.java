 ...
 */
public interface MyFaoritesApi {

    @POST("users/get-favorite-designs.json")

//http://192.168.1.39/zezign/webservice/users/get-favorite-designs.json
    Call<JsonElement> getDesignListViaJSON(@Body OrderClass body);
