 ...
 */
public interface DeleteDesignApi {

    @Multipart
    @POST("savedproducts/delete-saved-product.json")

    Call<JsonElement> deleteCreationViaJSON(@Part("saved_product_id") RequestBody productId);
