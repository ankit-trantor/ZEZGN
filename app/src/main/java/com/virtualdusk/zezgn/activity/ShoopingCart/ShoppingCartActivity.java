...
/**
 * Created by Amit Sharma on 11/7/2016.
 */
public class ShoppingCartActivity extends AbstractActivity implements DialogInterface{
    ...
    private TextView tvSubTotal, tvPromo,tvNoItem,tvCouponcode;
    private ImageView ivPromo, ivBack,ivRemove;
    private Button btnCheckOut,btnContinue;

    public static int totalPrice = 0, total_shipping = 0, TotalCartPrice, couponAmount = 0,mDotsCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cart_summary_screen);
        progress_dialog = new ProgressDialog(ShoppingCartActivity.this, R.style.MyTheme);
        ...
        if(user_id.equalsIgnoreCase("-1")){
            user_id = mUtilities.getDeviceId(ShoppingCartActivity.this);
        }
        findRes();
    ...
    private void findRes() {
        ...
        ivPromo = (ImageView) findViewById(R.id.ivPromo);
        ivRemove = (ImageView) findViewById(R.id.ivRemoveCode);
        ...
        btnCheckOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(user_id.equalsIgnoreCase(mUtilities.getDeviceId(ShoppingCartActivity.this))){
                    startActivity(new Intent(ShoppingCartActivity.this, AddGuestShippingDetailsActivity.class));
                }else{
                    startActivity(new Intent(ShoppingCartActivity.this, ShippingDetailsScreen.class));
                }
        ...
        ivPromo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mPromoCode.length() == 0) {
                    ...
                    if (new ConnectionDetector(ShoppingCartActivity.this).isConnectingToInternet()) {

                        applyCoupon();
                    } else {
                        Toast.makeText(ShoppingCartActivity.this,getString(R.string.no_internet),Toast.LENGTH_LONG).show();
                    }
    ...
    private void parseResponseDeletedCart(String message, int pos) {
        ...
        try {
            ...
            if (status.equals("200")) {
                ...
                ViewGroup vg = (ViewGroup) findViewById(R.id.image_count);
                vg.removeAllViews();
                ...
                SaveRecords.saveIntegerToPreference(getString(R.string.key_cartcount),mDotsCount,ShoppingCartActivity.this);
                ...
                if(mDotsCount == 1){
                  ...
                  ShoppingCartActivity.this.recreate();
...
//                    cartInfo.setPrice(productPrice+"");
    ...
    private void setAdapter() {
        ...
        cartAdapter = new CartAdapterAdapter(ShoppingCartActivity.this, arrCartItems);
...
//        gallery.setAdapter(cartAdapter);
    ...
    private void notifyPrice() {
        ...
        for (int i = 0; i < arrCartItems.size(); i++) {
            totalPrice = totalPrice + Integer.parseInt(arrCartItems.get(i).getPrice());
...
//            }
        ...
        tvShipping.setText("AED " + total_shipping);
        TotalCartPrice = totalPrice + total_shipping;
        tvSubTotal.setText("AED " + totalPrice);

        Log.e(TAG, "setAdapter: " + totalPrice);
    ...
    public class CartAdapterAdapter extends RecyclerView.Adapter<ShoppingCartActivity.MyviewHolder> {
        ...
        @Override
        public ShoppingCartActivity.MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_shoppoing_cart, parent, false);

            return new ShoppingCartActivity.MyviewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(ShoppingCartActivity.MyviewHolder holder, final int position) {
            ...
            holder.tvTotalPrice.setText("AED " + arrCartItems.get(position).getPrice());
            ...
            holder.ivDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mUtilities.showCancelableDialog(ShoppingCartActivity.this,"Do you want to delete this product?","Delete",
            ...
            String image = arrCartItems.get(position).getProduct_thumb();
//            final String pureBase64Encoded = image.substring(image.indexOf(",")  + 1);
//            final byte[] decodedBytes = Base64.decode(pureBase64Encoded, Base64.DEFAULT);
//            Bitmap decodedBitmap = BitmapFactory.decodeByteArray(decodedBytes, 0, decodedBytes.length);
//            holder.ivDesignPic.setImageBitmap(decodedBitmap);
...
//            if (view == null)
//
//                vi = inflater.inflate(R.layout.list_row_shoppoing_cart, null);
//
//
//            TextView tvDesignName = (TextView) vi.findViewById(R.id.tvDesignName);
//            TextView tvTotalPrice = (TextView) vi.findViewById(R.id.tvTotalPrice);
//            TextView tvTotalProductQuantity = (TextView) vi.findViewById(R.id.tvTotalProductQuantity);
//            TextView tvQuantityLess = (TextView) vi.findViewById(R.id.tvQuantityLess);
//            TextView tvQuantityIncrease = (TextView) vi.findViewById(R.id.tvQuantityIncrease);
...
//
//            tvDesignName.setText(arrCartItems.get(i).getDesign_title());
//            tvTotalProductQuantity.setText(arrCartItems.get(i).getQuantity());
//            tvTotalPrice.setText(arrCartItems.get(i).getPrice());
//
//
//            tvQuantityIncrease.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View view) {
//
//                    int quantity = Integer.parseInt(arrCartItems.get(i).getQuantity());
//
//                    if (quantity >= 1) {
//                        increaseQuantitySize(i, arrCartItems.get(i).getQuantity(), arrCartItems.get(i).getPrice(), 1);
//
//                    }
//                }
//            });
...
//
//                    if (quantity >= 2) {
//                        increaseQuantitySize(i, arrCartItems.get(i).getQuantity(), arrCartItems.get(i).getPrice(), 0);
//
//                    }
//                }
//            });
//
//            Log.e(TAG, "getView: " + arrCartItems.get(i).getPrice() + "," + arrCartItems.get(i).getQuantity());
//
//
...
//        }
    ...
    public class MyviewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView ivDelete,ivDesignPic;
